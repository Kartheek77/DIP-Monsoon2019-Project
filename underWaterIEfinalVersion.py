...
def EnhanceTheImage(GivenImage):
	...
	result = differential_evolution(objectiveFunction, bounds,args = (GivenImage,cumulImageProbDensity1),disp = True,strategy = 'best1bin',tol=0.001,popsize=40,mutation=0.8,recombination = 0.7,maxiter = 100,workers = 30,updating= 'immediate') 
